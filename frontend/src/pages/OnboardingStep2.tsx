  ...
  return (
    <div className="onboarding-screen chat-static">
      <div className="text-block">
        ...
        <p className="subtext">
          Ruby will guide you through quick chats to uncover your goals, strengths, and values.
        </p>
      </div>
      ...
      <div className="chat-area">
        <div className="ruby-chat-left">
          ...
          <div className="ruby-bubbles">
            <div className="bubble-primary">Hi, I’m Ruby! Your TruNorth Coach.</div>
            <div className="bubble-secondary">
              Thinking about a career change or even just exploring possibilities can feel exciting,
              overwhelming, or somewhere in between. <br />
              What brings you here today?
            </div>
            <img src={replyBubbles} alt="Reply Bubbles" className="reply-bubbles right" />
          </div>
        </div>
      </div>
